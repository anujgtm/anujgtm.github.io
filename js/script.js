$(document).ready(function() {
   $(window).load(function() {
    ...
    $(".work-one").hover(function() {
        $("#work").css("background-image","url('images/splash-back.jpg')");
    ...
    $(".work-two").hover(function() {
        $("#work").css("background-image","url('images/hogged-up-back.jpg')");
    ...
    $(".work-four").hover(function() {
        $("#work").css("background-image","url('images/keystone-back.jpg')");
    ...
    $(".work-five").hover(function() {
        $("#work").css("background-image","url('images/seetech-back.jpg')");
    ...
    $(".work-six").hover(function() {
        $("#work").css("background-image","url('images/wedding-back.jpg')");
        $(".work-text").css("color","rgba(0, 0, 0, .3)");
        $(".light-back").css("color","rgba(0, 0, 0, .3)");
    },function(){
    $("#work").css("background-image","none");
